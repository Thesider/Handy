...
export const WorkerSidebar = () => {
    ...
    return (
        <aside className="flex w-64 flex-col border-r border-slate-200 bg-white transition-colors duration-300">
            <div className="flex h-full flex-col justify-between p-4">
                <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-3 px-2 py-2">
                        <div
                            className={`aspect-square size-10 rounded-full border border-slate-200 bg-cover bg-center ${styles.profileAvatar}`}
                            aria-hidden="true"
                        />
                        <div className="flex flex-col">
                            ...
                            <p className="text-xs font-medium leading-normal text-slate-500">
                                {displayName} • Pro
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-2 border-t border-slate-100 pt-4">
                    <button
                        className="flex w-full items-center gap-3 px-3 py-2 text-slate-500 hover:text-slate-700"
                        onClick={logout}
                        type="button"
                    >
