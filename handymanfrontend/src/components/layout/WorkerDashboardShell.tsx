...
export const WorkerDashboardShell = ({ children }: { children: ReactNode }) => (
    <div className="flex h-screen w-full overflow-hidden bg-background-light font-display text-slate-900">
        <WorkerSidebar />
        <main
            className={`flex-1 overflow-y-auto bg-background-light ${styles.scrollbarHide}`}
        >
